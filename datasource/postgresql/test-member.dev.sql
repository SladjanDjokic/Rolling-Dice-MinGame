INSERT INTO member
        ...
        ('isabella.richmond@sustenza.net', 'Isabella', 'Richmond', 'isabella.richmond@sustenza.net', '2000-02-14', 'Sustenza', crypt('password', gen_salt('bf')),2,3),
        ('maricela.jarvis@firewax.me', 'Maricela', 'Jarvis', 'maricela.jarvis@firewax.me', '1996-10-25', 'Firewax', crypt('password', gen_salt('bf')),2,3),
        ('emilia.davis@centrexin.biz', 'Emilia', 'Davis', 'emilia.davis@centrexin.biz', '1986-10-16', 'Centrexin', crypt('password', gen_salt('bf')),2,4),
        ('kirk.mclaughlin@empirica.ca', 'Kirk', 'Mclaughlin', 'kirk.mclaughlin@empirica.ca', '1938-03-07', 'Empirica', crypt('password', gen_salt('bf')),2,4),
        ('avery.levine@niquent.tv', 'Avery', 'Levine', 'avery.levine@niquent.tv', '1945-11-12', 'Niquent', crypt('password', gen_salt('bf')),2,4),
        ('serena.terry@overfork.io', 'Serena', 'Terry', 'serena.terry@overfork.io', '1932-09-27', 'Overfork', crypt('password', gen_salt('bf')),2,4),
        ('saunders.gates@jetsilk.org', 'Saunders', 'Gates', 'saunders.gates@jetsilk.org', '2019-10-04', 'Jetsilk', crypt('password', gen_salt('bf')),2,4),
        ('paulette.mcmahon@voratak.us', 'Paulette', 'Mcmahon', 'paulette.mcmahon@voratak.us', '1947-04-17', 'Voratak', crypt('password', gen_salt('bf')),2,4),
        ('rhoda.potter@slumberia.co.uk', 'Rhoda', 'Potter', 'rhoda.potter@slumberia.co.uk', '1977-09-11', 'Slumberia', crypt('password', gen_salt('bf')),2,4),
        ('benton.whitehead@cormoran.com', 'Benton', 'Whitehead', 'benton.whitehead@cormoran.com', '1987-06-07', 'Cormoran', crypt('password', gen_salt('bf')),2,4),
